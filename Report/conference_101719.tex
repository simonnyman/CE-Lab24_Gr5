...
We are positive that a lot more complex solution is required to achieve a better performance, but compared to our solution those performance gains would be marginal relative to the complexity needed.  
\section{Conclusion}
