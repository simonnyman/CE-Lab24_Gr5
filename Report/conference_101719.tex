...
To make these parameters easily adjustable, we introduced them as global variables, except for the our angular divison of the LiDAR readings, which we elaborate on later.


as mentioned before ... cones, distance, speed, in that order
Simplicity...
Limitations... (react time + hardware)
\section{Conclusion}
