...
For the testing of the robot, we used varying sets of trial courses, but attempted to make them as similar as possible in regards to the complexity, as in that way we made sure the test data could be comparable.
In addition, in between the testruns we also conducted experiments where we would only focus on singular aspects of the whole navigational process.
\begin{figure}[h]
