...
For the navigation of the robot we chose an object detecting strategy, were we made the robots actions dependent on where the closest object was located.
...
\begin{figure}[htbp]
    ...
    \label{sec:distances}
    \end{figure}
The logic was developed to exceed on our performance criteria of limiting collision while achieveing a high speed. 
Which in turn will allow the robot to move fast through the obstacle course, thereby detecting as many "victims" as possible.
